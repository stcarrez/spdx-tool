...
private
   ...
   K_253           : aliased constant String := "standard/LGPL-3.0";
   K_254           : aliased constant String := "standard/LGPL-3.0-linking-exception";
   K_255           : aliased constant String := "standard/LLGPL";
   K_256           : aliased constant String := "standard/LLVM-exception";
   K_257           : aliased constant String := "standard/LOOP";
   K_258           : aliased constant String := "standard/LPD-document";
   K_259           : aliased constant String := "standard/LPPL-1.0";
   K_260           : aliased constant String := "standard/LPPL-1.1";
   K_261           : aliased constant String := "standard/LPPL-1.2";
   K_262           : aliased constant String := "standard/LPPL-1.3a";
   K_263           : aliased constant String := "standard/LPPL-1.3c";
   K_264           : aliased constant String := "standard/LZMA-SDK-9.11-to-9.20";
   K_265           : aliased constant String := "standard/LZMA-SDK-9.22";
   K_266           : aliased constant String := "standard/LZMA-exception";
   K_267           : aliased constant String := "standard/Latex2e";
   K_268           : aliased constant String := "standard/Latex2e-translated-notice";
   K_269           : aliased constant String := "standard/Leptonica";
   K_270           : aliased constant String := "standard/Libtool-exception";
   K_271           : aliased constant String := "standard/Linux-OpenIB";
   K_272           : aliased constant String := "standard/Linux-man-pages-1-para";
   K_273           : aliased constant String := "standard/Linux-man-pages-copyleft";
   K_274           : aliased constant String := "standard/Linux-man-pages-copyleft-2-para";
   K_275           : aliased constant String := "standard/Linux-man-pages-copyleft-var";
   K_276           : aliased constant String := "standard/Linux-syscall-note";
   K_277           : aliased constant String := "standard/Lucida-Bitmap-Fonts";
   K_278           : aliased constant String := "standard/MIT";
   K_279           : aliased constant String := "standard/MIT-0";
   K_280           : aliased constant String := "standard/MIT-CMU";
   K_281           : aliased constant String := "standard/MIT-Festival";
   K_282           : aliased constant String := "standard/MIT-Khronos-old";
   K_283           : aliased constant String := "standard/MIT-Modern-Variant";
   K_284           : aliased constant String := "standard/MIT-Wu";
   K_285           : aliased constant String := "standard/MIT-advertising";
   K_286           : aliased constant String := "standard/MIT-enna";
   K_287           : aliased constant String := "standard/MIT-feh";
   K_288           : aliased constant String := "standard/MIT-open-group";
   K_289           : aliased constant String := "standard/MIT-testregex";
   K_290           : aliased constant String := "standard/MITNFA";
   K_291           : aliased constant String := "standard/MMIXware";
   K_292           : aliased constant String := "standard/MPEG-SSG";
   K_293           : aliased constant String := "standard/MPL-1.0";
   K_294           : aliased constant String := "standard/MPL-1.1";
   K_295           : aliased constant String := "standard/MPL-2.0";
   K_296           : aliased constant String := "standard/MPL-2.0-no-copyleft-exception";
   K_297           : aliased constant String := "standard/MS-LPL";
   K_298           : aliased constant String := "standard/MS-PL";
   K_299           : aliased constant String := "standard/MS-RL";
   K_300           : aliased constant String := "standard/MTLL";
   K_301           : aliased constant String := "standard/Mackerras-3-Clause";
   K_302           : aliased constant String := "standard/Mackerras-3-Clause-acknowledgment";
   K_303           : aliased constant String := "standard/MakeIndex";
   K_304           : aliased constant String := "standard/Martin-Birgmeier";
   K_305           : aliased constant String := "standard/McPhee-slideshow";
   K_306           : aliased constant String := "standard/Minpack";
   K_307           : aliased constant String := "standard/MirOS";
   K_308           : aliased constant String := "standard/MulanPSL-1.0";
   K_309           : aliased constant String := "standard/MulanPSL-2.0";
   K_310           : aliased constant String := "standard/Multics";
   K_311           : aliased constant String := "standard/Mup";
   K_312           : aliased constant String := "standard/NAIST-2003";
   K_313           : aliased constant String := "standard/NCL";
   K_314           : aliased constant String := "standard/NCSA";
   K_315           : aliased constant String := "standard/NICTA-1.0";
   K_316           : aliased constant String := "standard/NIST-PD";
   K_317           : aliased constant String := "standard/NIST-PD-fallback";
   K_318           : aliased constant String := "standard/NIST-Software";
   K_319           : aliased constant String := "standard/NLPL";
   K_320           : aliased constant String := "standard/NRL";
   K_321           : aliased constant String := "standard/NTP";
   K_322           : aliased constant String := "standard/NTP-0";
   K_323           : aliased constant String := "standard/Naumen";
   K_324           : aliased constant String := "standard/NetCDF";
   K_325           : aliased constant String := "standard/Newsletr";
   K_326           : aliased constant String := "standard/Nokia-Qt-exception-1.1";
   K_327           : aliased constant String := "standard/Noweb";
   K_328           : aliased constant String := "standard/Nunit";
   K_329           : aliased constant String := "standard/OAR";
   K_330           : aliased constant String := "standard/OCCT-exception-1.0";
   K_331           : aliased constant String := "standard/OCLC-2.0";
   K_332           : aliased constant String := "standard/OCaml-LGPL-linking-exception";
   K_333           : aliased constant String := "standard/OFFIS";
   K_334           : aliased constant String := "standard/OGC-1.0";
   K_335           : aliased constant String := "standard/OLDAP-2.0";
   K_336           : aliased constant String := "standard/OLDAP-2.0.1";
   K_337           : aliased constant String := "standard/OLDAP-2.1";
   K_338           : aliased constant String := "standard/OLDAP-2.2";
   K_339           : aliased constant String := "standard/OLDAP-2.2.1";
   K_340           : aliased constant String := "standard/OLDAP-2.2.2";
   K_341           : aliased constant String := "standard/OLDAP-2.3";
   K_342           : aliased constant String := "standard/OLDAP-2.4";
   K_343           : aliased constant String := "standard/OLDAP-2.5";
   K_344           : aliased constant String := "standard/OLDAP-2.6";
   K_345           : aliased constant String := "standard/OLDAP-2.7";
   K_346           : aliased constant String := "standard/OLDAP-2.8";
   K_347           : aliased constant String := "standard/OML";
   K_348           : aliased constant String := "standard/OSL-1.0";
   K_349           : aliased constant String := "standard/OSL-1.1";
   K_350           : aliased constant String := "standard/OSL-2.0";
   K_351           : aliased constant String := "standard/OSL-2.1";
   K_352           : aliased constant String := "standard/OSL-3.0";
   K_353           : aliased constant String := "standard/OpenJDK-assembly-exception-1.0";
   K_354           : aliased constant String := "standard/OpenSSL-standalone";
   K_355           : aliased constant String := "standard/OpenVision";
   K_356           : aliased constant String := "standard/PADL";
   K_357           : aliased constant String := "standard/PHP-3.0";
   K_358           : aliased constant String := "standard/PHP-3.01";
   K_359           : aliased constant String := "standard/PS-or-PDF-font-exception-20170817";
   K_360           : aliased constant String := "standard/Parity-6.0.0";
   K_361           : aliased constant String := "standard/Pixar";
   K_362           : aliased constant String := "standard/Plexus";
   K_363           : aliased constant String := "standard/PostgreSQL";
   K_364           : aliased constant String := "standard/QPL-1.0-INRIA-2004-exception";
   K_365           : aliased constant String := "standard/Qhull";
   K_366           : aliased constant String := "standard/Qt-GPL-exception-1.0";
   K_367           : aliased constant String := "standard/Qt-LGPL-exception-1.1";
   K_368           : aliased constant String := "standard/Qwt-exception-1.0";
   K_369           : aliased constant String := "standard/RPSL-1.0";
   K_370           : aliased constant String := "standard/RSA-MD";
   K_371           : aliased constant String := "standard/Rdisc";
   K_372           : aliased constant String := "standard/Ruby";
   K_373           : aliased constant String := "standard/SANE-exception";
   K_374           : aliased constant String := "standard/SAX-PD";
   K_375           : aliased constant String := "standard/SAX-PD-2.0";
   K_376           : aliased constant String := "standard/SCEA";
   K_377           : aliased constant String := "standard/SGI-B-1.0";
   K_378           : aliased constant String := "standard/SGI-B-1.1";
   K_379           : aliased constant String := "standard/SGI-B-2.0";
   K_380           : aliased constant String := "standard/SGI-OpenGL";
   K_381           : aliased constant String := "standard/SGP4";
   K_382           : aliased constant String := "standard/SHL-0.5";
   K_383           : aliased constant String := "standard/SHL-0.51";
   K_384           : aliased constant String := "standard/SHL-2.0";
   K_385           : aliased constant String := "standard/SHL-2.1";
   K_386           : aliased constant String := "standard/SISSL";
   K_387           : aliased constant String := "standard/SISSL-1.2";
   K_388           : aliased constant String := "standard/SL";
   K_389           : aliased constant String := "standard/SMLNJ";
   K_390           : aliased constant String := "standard/SMPPL";
   K_391           : aliased constant String := "standard/SPL-1.0";
   K_392           : aliased constant String := "standard/SSH-OpenSSH";
   K_393           : aliased constant String := "standard/SSH-short";
   K_394           : aliased constant String := "standard/SSLeay-standalone";
   K_395           : aliased constant String := "standard/SSPL-1.0";
   K_396           : aliased constant String := "standard/SWI-exception";
   K_397           : aliased constant String := "standard/SWL";
   K_398           : aliased constant String := "standard/Saxpath";
   K_399           : aliased constant String := "standard/SchemeReport";
   K_400           : aliased constant String := "standard/SimPL-2.0";
   K_401           : aliased constant String := "standard/Soundex";
   K_402           : aliased constant String := "standard/Spencer-86";
   K_403           : aliased constant String := "standard/Spencer-94";
   K_404           : aliased constant String := "standard/Spencer-99";
   K_405           : aliased constant String := "standard/StandardML-NJ";
   K_406           : aliased constant String := "standard/Sun-PPP";
   K_407           : aliased constant String := "standard/Sun-PPP-2000";
   K_408           : aliased constant String := "standard/SunPro";
   K_409           : aliased constant String := "standard/Swift-exception";
   K_410           : aliased constant String := "standard/Symlinks";
   K_411           : aliased constant String := "standard/TCL";
   K_412           : aliased constant String := "standard/TCP-wrappers";
   K_413           : aliased constant String := "standard/TGPPL-1.0";
   K_414           : aliased constant String := "standard/TMate";
   K_415           : aliased constant String := "standard/TOSL";
   K_416           : aliased constant String := "standard/TPDL";
   K_417           : aliased constant String := "standard/TPL-1.0";
   K_418           : aliased constant String := "standard/TTWL";
   K_419           : aliased constant String := "standard/TTYP0";
   K_420           : aliased constant String := "standard/TU-Berlin-1.0";
   K_421           : aliased constant String := "standard/TU-Berlin-2.0";
   K_422           : aliased constant String := "standard/TermReadKey";
   K_423           : aliased constant String := "standard/Texinfo-exception";
   K_424           : aliased constant String := "standard/UBDL-exception";
   K_425           : aliased constant String := "standard/UCAR";
   K_426           : aliased constant String := "standard/UCL-1.0";
   K_427           : aliased constant String := "standard/UMich-Merit";
   K_428           : aliased constant String := "standard/UPL-1.0";
   K_429           : aliased constant String := "standard/URT-RLE";
   K_430           : aliased constant String := "standard/Unicode-3.0";
   K_431           : aliased constant String := "standard/Unicode-DFS-2015";
   K_432           : aliased constant String := "standard/Unicode-DFS-2016";
   K_433           : aliased constant String := "standard/Universal-FOSS-exception-1.0";
   K_434           : aliased constant String := "standard/UnixCrypt";
   K_435           : aliased constant String := "standard/Unlicense";
   K_436           : aliased constant String := "standard/VOSTROM";
   K_437           : aliased constant String := "standard/VSL-1.0";
   K_438           : aliased constant String := "standard/W3C";
   K_439           : aliased constant String := "standard/W3C-19980720";
   K_440           : aliased constant String := "standard/W3C-20150513";
   K_441           : aliased constant String := "standard/WTFPL";
   K_442           : aliased constant String := "standard/Widget-Workshop";
   K_443           : aliased constant String := "standard/Wsuipa";
   K_444           : aliased constant String := "standard/WxWindows-exception-3.1";
   K_445           : aliased constant String := "standard/X11";
   K_446           : aliased constant String := "standard/X11-distribute-modifications-variant";
   K_447           : aliased constant String := "standard/XFree86-1.1";
   K_448           : aliased constant String := "standard/XSkat";
   K_449           : aliased constant String := "standard/Xdebug-1.03";
   K_450           : aliased constant String := "standard/Xerox";
   K_451           : aliased constant String := "standard/Xfig";
   K_452           : aliased constant String := "standard/Xnet";
   K_453           : aliased constant String := "standard/ZPL-1.1";
   K_454           : aliased constant String := "standard/ZPL-2.0";
   K_455           : aliased constant String := "standard/ZPL-2.1";
   K_456           : aliased constant String := "standard/Zed";
   K_457           : aliased constant String := "standard/Zeeff";
   K_458           : aliased constant String := "standard/Zend-2.0";
   K_459           : aliased constant String := "standard/Zlib";
   K_460           : aliased constant String := "standard/bcrypt-Solar-Designer";
   K_461           : aliased constant String := "standard/blessing";
   K_462           : aliased constant String := "standard/bzip2-1.0.5";
   K_463           : aliased constant String := "standard/bzip2-1.0.6";
   K_464           : aliased constant String := "standard/check-cvs";
   K_465           : aliased constant String := "standard/checkmk";
   K_466           : aliased constant String := "standard/cryptsetup-OpenSSL-exception";
   K_467           : aliased constant String := "standard/curl";
   K_468           : aliased constant String := "standard/diffmark";
   K_469           : aliased constant String := "standard/dtoa";
   K_470           : aliased constant String := "standard/dvipdfm";
   K_471           : aliased constant String := "standard/eCos-2.0";
   K_472           : aliased constant String := "standard/eCos-exception-2.0";
   K_473           : aliased constant String := "standard/fmt-exception";
   K_474           : aliased constant String := "standard/freertos-exception-2.0";
   K_475           : aliased constant String := "standard/fwlw";
   K_476           : aliased constant String := "standard/gnu-javamail-exception";
   K_477           : aliased constant String := "standard/gnuplot";
   K_478           : aliased constant String := "standard/gtkbook";
   K_479           : aliased constant String := "standard/hdparm";
   K_480           : aliased constant String := "standard/i2p-gpl-java-exception";
   K_481           : aliased constant String := "standard/iMatix";
   K_482           : aliased constant String := "standard/libpng-2.0";
   K_483           : aliased constant String := "standard/libpri-OpenH323-exception";
   K_484           : aliased constant String := "standard/libselinux-1.0";
   K_485           : aliased constant String := "standard/libtiff";
   K_486           : aliased constant String := "standard/libutil-David-Nugent";
   K_487           : aliased constant String := "standard/lsof";
   K_488           : aliased constant String := "standard/magaz";
   K_489           : aliased constant String := "standard/mailprio";
   K_490           : aliased constant String := "standard/metamail";
   K_491           : aliased constant String := "standard/mif-exception";
   K_492           : aliased constant String := "standard/mpi-permissive";
   K_493           : aliased constant String := "standard/mpich2";
   K_494           : aliased constant String := "standard/mplus";
   K_495           : aliased constant String := "standard/openvpn-openssl-exception";
   K_496           : aliased constant String := "standard/pkgconf";
   K_497           : aliased constant String := "standard/pnmstitch";
   K_498           : aliased constant String := "standard/psfrag";
   K_499           : aliased constant String := "standard/psutils";
   K_500           : aliased constant String := "standard/python-ldap";
   K_501           : aliased constant String := "standard/radvd";
   K_502           : aliased constant String := "standard/snprintf";
   K_503           : aliased constant String := "standard/softSurfer";
   K_504           : aliased constant String := "standard/ssh-keyscan";
   K_505           : aliased constant String := "standard/stunnel-exception";
   K_506           : aliased constant String := "standard/swrule";
   K_507           : aliased constant String := "standard/threeparttable";
   K_508           : aliased constant String := "standard/u-boot-exception-2.0";
   K_509           : aliased constant String := "standard/ulem";
   K_510           : aliased constant String := "standard/vsftpd-openssl-exception";
   K_511           : aliased constant String := "standard/w3m";
   K_512           : aliased constant String := "standard/wxWindows";
   K_513           : aliased constant String := "standard/x11vnc-openssl-exception";
   K_514           : aliased constant String := "standard/xinetd";
   K_515           : aliased constant String := "standard/xkeyboard-config-Zinoviev";
   K_516           : aliased constant String := "standard/xlock";
   K_517           : aliased constant String := "standard/xpp";
   K_518           : aliased constant String := "standard/xzoom";
   K_519           : aliased constant String := "standard/zlib-acknowledgement";
