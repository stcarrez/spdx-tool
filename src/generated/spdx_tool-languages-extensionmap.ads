...
private
   ...
   K_720           : aliased constant String := "lark";
   M_720           : aliased constant String := "Lark";
   K_721           : aliased constant String := "ml4";
   M_721           : aliased constant String := "OCaml";
   K_722           : aliased constant String := "axi";
   M_722           : aliased constant String := "NetLinx";
   K_723           : aliased constant String := "osm";
   M_723           : aliased constant String := "XML";
   K_724           : aliased constant String := "praat";
   M_724           : aliased constant String := "Praat";
   K_725           : aliased constant String := "sbt";
   M_725           : aliased constant String := "Scala";
   K_726           : aliased constant String := "xht";
   M_726           : aliased constant String := "HTML";
   K_727           : aliased constant String := "typ";
   M_727           : aliased constant String := "XML,Typst";
   K_728           : aliased constant String := "6pl";
   M_728           : aliased constant String := "Raku";
   K_729           : aliased constant String := "ejs.t";
   M_729           : aliased constant String := "EJS";
   K_730           : aliased constant String := "6pm";
   M_730           : aliased constant String := "Raku";
   K_731           : aliased constant String := "kicad_sch";
   M_731           : aliased constant String := "KiCad Schematic";
   K_732           : aliased constant String := "axs";
   M_732           : aliased constant String := "NetLinx";
   K_733           : aliased constant String := "cake";
   M_733           : aliased constant String := "CoffeeScript,C#";
   K_734           : aliased constant String := "reds";
   M_734           : aliased constant String := "Red";
   K_735           : aliased constant String := "shen";
   M_735           : aliased constant String := "Shen";
   K_736           : aliased constant String := "4gl";
   M_736           : aliased constant String := "Genero 4gl";
   K_737           : aliased constant String := "mjs";
   M_737           : aliased constant String := "JavaScript";
   K_738           : aliased constant String := "axml";
   M_738           : aliased constant String := "XML";
   K_739           : aliased constant String := "mathematica";
   M_739           : aliased constant String := "Mathematica";
   K_740           : aliased constant String := "kak";
   M_740           : aliased constant String := "KakouneScript";
   K_741           : aliased constant String := "zsh";
   M_741           : aliased constant String := "Shell";
   K_742           : aliased constant String := "jl";
   M_742           : aliased constant String := "Julia";
   K_743           : aliased constant String := "rpy";
   M_743           : aliased constant String := "Python,Ren'Py";
   K_744           : aliased constant String := "mjml";
   M_744           : aliased constant String := "XML";
   K_745           : aliased constant String := "sdc";
   M_745           : aliased constant String := "Tcl";
   K_746           : aliased constant String := "jq";
   M_746           : aliased constant String := "jq,JSONiq";
   K_747           : aliased constant String := "js";
   M_747           : aliased constant String := "JavaScript";
   K_748           : aliased constant String := "avdl";
   M_748           : aliased constant String := "Avro IDL";
   K_749           : aliased constant String := "grt";
   M_749           : aliased constant String := "Groovy";
   K_750           : aliased constant String := "geom";
   M_750           : aliased constant String := "GLSL";
   K_751           : aliased constant String := "cscfg";
   M_751           : aliased constant String := "XML";
   K_752           : aliased constant String := "bbclass";
   M_752           : aliased constant String := "BitBake";
   K_753           : aliased constant String := "scad";
   M_753           : aliased constant String := "OpenSCAD";
   K_754           : aliased constant String := "4DProject";
   M_754           : aliased constant String := "JSON";
   K_755           : aliased constant String := "mli";
   M_755           : aliased constant String := "OCaml";
   K_756           : aliased constant String := "wxi";
   M_756           : aliased constant String := "XML";
   K_757           : aliased constant String := "mll";
   M_757           : aliased constant String := "OCaml";
   K_758           : aliased constant String := "jsonld";
   M_758           : aliased constant String := "JSONLD";
   K_759           : aliased constant String := "wxl";
   M_759           : aliased constant String := "XML";
   K_760           : aliased constant String := "dwl";
   M_760           : aliased constant String := "DataWeave";
   K_761           : aliased constant String := "pic";
   M_761           : aliased constant String := "Pic";
   K_762           : aliased constant String := "ld";
   M_762           : aliased constant String := "Linker Script";
   K_763           : aliased constant String := "xml.dist";
   M_763           : aliased constant String := "XML";
   K_764           : aliased constant String := "pig";
   M_764           : aliased constant String := "PigLatin";
   K_765           : aliased constant String := "wxs";
   M_765           : aliased constant String := "XML";
   K_766           : aliased constant String := "ll";
   M_766           : aliased constant String := "LLVM";
   K_767           : aliased constant String := "mly";
   M_767           : aliased constant String := "OCaml";
   K_768           : aliased constant String := "sqlrpgle";
   M_768           : aliased constant String := "RPGLE";
   K_769           : aliased constant String := "gtl";
   M_769           : aliased constant String := "Gerber Image";
   K_770           : aliased constant String := "sfd";
   M_770           : aliased constant String := "Spline Font Database";
   K_771           : aliased constant String := "pir";
   M_771           : aliased constant String := "Parrot Internal Representation";
   K_772           : aliased constant String := "ls";
   M_772           : aliased constant String := "LoomScript,LiveScript";
   K_773           : aliased constant String := "gto";
   M_773           : aliased constant String := "Gerber Image";
   K_774           : aliased constant String := "gtp";
   M_774           : aliased constant String := "Gerber Image";
   K_775           : aliased constant String := "xlf";
   M_775           : aliased constant String := "XML";
   K_776           : aliased constant String := "cppobjdump";
   M_776           : aliased constant String := "Cpp-ObjDump";
   K_777           : aliased constant String := "imba";
   M_777           : aliased constant String := "Imba";
   K_778           : aliased constant String := "gts";
   M_778           : aliased constant String := "Glimmer TS,Gerber Image";
   K_779           : aliased constant String := "plsql";
   M_779           : aliased constant String := "PLSQL";
   K_780           : aliased constant String := "ahkl";
   M_780           : aliased constant String := "AutoHotkey";
   K_781           : aliased constant String := "ly";
   M_781           : aliased constant String := "LilyPond";
   K_782           : aliased constant String := "forth";
   M_782           : aliased constant String := "Forth";
   K_783           : aliased constant String := "self";
   M_783           : aliased constant String := "Self";
   K_784           : aliased constant String := "sarif";
   M_784           : aliased constant String := "JSON";
   K_785           : aliased constant String := "sublime-mousemap";
   M_785           : aliased constant String := "JSON with Comments";
   K_786           : aliased constant String := "natvis";
   M_786           : aliased constant String := "XML";
   K_787           : aliased constant String := "owl";
   M_787           : aliased constant String := "Web Ontology Language";
   K_788           : aliased constant String := "snap";
   M_788           : aliased constant String := "Jest Snapshot";
   K_789           : aliased constant String := "pyde";
   M_789           : aliased constant String := "Python";
   K_790           : aliased constant String := "tfvars";
   M_790           : aliased constant String := "HCL";
   K_791           : aliased constant String := "mdwn";
   M_791           : aliased constant String := "Markdown";
   K_792           : aliased constant String := "sfv";
   M_792           : aliased constant String := "Simple File Verification";
   K_793           : aliased constant String := "emacs.desktop";
   M_793           : aliased constant String := "Emacs Lisp";
   K_794           : aliased constant String := "rtf";
   M_794           : aliased constant String := "Rich Text Format";
   K_795           : aliased constant String := "hhi";
   M_795           : aliased constant String := "Hack";
   K_796           : aliased constant String := "vcl";
   M_796           : aliased constant String := "VCL";
   K_797           : aliased constant String := "zsh-theme";
   M_797           : aliased constant String := "Shell";
   K_798           : aliased constant String := "cbl";
   M_798           : aliased constant String := "COBOL";
   K_799           : aliased constant String := "p4";
   M_799           : aliased constant String := "P4";
   K_800           : aliased constant String := "vert";
   M_800           : aliased constant String := "GLSL";
   K_801           : aliased constant String := "hack";
   M_801           : aliased constant String := "Hack";
   K_802           : aliased constant String := "p6";
   M_802           : aliased constant String := "Raku";
   K_803           : aliased constant String := "pm6";
   M_803           : aliased constant String := "Raku";
   K_804           : aliased constant String := "nb";
   M_804           : aliased constant String := "Text,Mathematica";
   K_805           : aliased constant String := "pkb";
   M_805           : aliased constant String := "PLSQL";
   K_806           : aliased constant String := "nc";
   M_806           : aliased constant String := "nesC";
   K_807           : aliased constant String := "dyl";
   M_807           : aliased constant String := "Dylan";
   K_808           : aliased constant String := "p8";
   M_808           : aliased constant String := "Lua";
   K_809           : aliased constant String := "irclog";
   M_809           : aliased constant String := "IRC log";
   K_810           : aliased constant String := "ne";
   M_810           : aliased constant String := "Nearley";
   K_811           : aliased constant String := "nf";
   M_811           : aliased constant String := "Nextflow";
   K_812           : aliased constant String := "wren";
   M_812           : aliased constant String := "Wren";
   K_813           : aliased constant String := "xsp-config";
   M_813           : aliased constant String := "XPages";
   K_814           : aliased constant String := "kicad_mod";
   M_814           : aliased constant String := "KiCad Layout";
   K_815           : aliased constant String := "ni";
   M_815           : aliased constant String := "Inform 7";
   K_816           : aliased constant String := "cbx";
   M_816           : aliased constant String := "TeX";
   K_817           : aliased constant String := "i7x";
   M_817           : aliased constant String := "Inform 7";
   K_818           : aliased constant String := "xacro";
   M_818           : aliased constant String := "XML";
   K_819           : aliased constant String := "nl";
   M_819           : aliased constant String := "NewLisp,NL";
   K_820           : aliased constant String := "pkl";
   M_820           : aliased constant String := "Pickle";
   K_821           : aliased constant String := "vbproj";
   M_821           : aliased constant String := "XML";
   K_822           : aliased constant String := "scrbl";
   M_822           : aliased constant String := "Racket";
   K_823           : aliased constant String := "code-snippets";
   M_823           : aliased constant String := "JSON with Comments";
   K_824           : aliased constant String := "bpl";
   M_824           : aliased constant String := "Boogie";
   K_825           : aliased constant String := "no";
   M_825           : aliased constant String := "Text";
   K_826           : aliased constant String := "php3";
   M_826           : aliased constant String := "PHP";
   K_827           : aliased constant String := "php4";
   M_827           : aliased constant String := "PHP";
   K_828           : aliased constant String := "nr";
   M_828           : aliased constant String := "Roff";
   K_829           : aliased constant String := "php5";
   M_829           : aliased constant String := "PHP";
   K_830           : aliased constant String := "jsb";
   M_830           : aliased constant String := "JavaScript";
   K_831           : aliased constant String := "pks";
   M_831           : aliased constant String := "PLSQL";
   K_832           : aliased constant String := "tfstate.backup";
   M_832           : aliased constant String := "JSON";
   K_833           : aliased constant String := "nu";
   M_833           : aliased constant String := "Nushell,Nu";
   K_834           : aliased constant String := "fshader";
   M_834           : aliased constant String := "GLSL";
   K_835           : aliased constant String := "druby";
   M_835           : aliased constant String := "Mirah";
   K_836           : aliased constant String := "jsh";
   M_836           : aliased constant String := "Java";
   K_837           : aliased constant String := "ny";
   M_837           : aliased constant String := "Common Lisp";
   K_838           : aliased constant String := "eml";
   M_838           : aliased constant String := "E-mail";
   K_839           : aliased constant String := "nbp";
   M_839           : aliased constant String := "Mathematica";
   K_840           : aliased constant String := "gvy";
   M_840           : aliased constant String := "Groovy";
   K_841           : aliased constant String := "jsm";
   M_841           : aliased constant String := "JavaScript";
   K_842           : aliased constant String := "cdc";
   M_842           : aliased constant String := "Cadence";
   K_843           : aliased constant String := "rbuistate";
   M_843           : aliased constant String := "REALbasic";
   K_844           : aliased constant String := "jsp";
   M_844           : aliased constant String := "Java Server Pages";
   K_845           : aliased constant String := "cdf";
   M_845           : aliased constant String := "Mathematica";
   K_846           : aliased constant String := "jss";
   M_846           : aliased constant String := "JavaScript";
   K_847           : aliased constant String := "command";
   M_847           : aliased constant String := "Shell";
   K_848           : aliased constant String := "scala";
   M_848           : aliased constant String := "Scala";
   K_849           : aliased constant String := "jst";
   M_849           : aliased constant String := "EJS";
   K_850           : aliased constant String := "gleam";
   M_850           : aliased constant String := "Gleam";
   K_851           : aliased constant String := "r2";
   M_851           : aliased constant String := "Rebol";
   K_852           : aliased constant String := "fsproj";
   M_852           : aliased constant String := "XML";
   K_853           : aliased constant String := "jsx";
   M_853           : aliased constant String := "JavaScript";
   K_854           : aliased constant String := "r3";
   M_854           : aliased constant String := "Rebol";
   K_855           : aliased constant String := "veo";
   M_855           : aliased constant String := "Verilog";
   K_856           : aliased constant String := "mpl";
   M_856           : aliased constant String := "JetBrains MPS";
   K_857           : aliased constant String := "bicep";
   M_857           : aliased constant String := "Bicep";
   K_858           : aliased constant String := "pb";
   M_858           : aliased constant String := "PureBasic";
   K_859           : aliased constant String := "cxx-objdump";
   M_859           : aliased constant String := "Cpp-ObjDump";
   K_860           : aliased constant String := "cds";
   M_860           : aliased constant String := "CAP CDS";
   K_861           : aliased constant String := "pd";
   M_861           : aliased constant String := "Pure Data";
   K_862           : aliased constant String := "flux";
   M_862           : aliased constant String := "FLUX";
   K_863           : aliased constant String := "2da";
   M_863           : aliased constant String := "2-Dimensional Array";
   K_864           : aliased constant String := "mps";
   M_864           : aliased constant String := "JetBrains MPS";
   K_865           : aliased constant String := "brd";
   M_865           : aliased constant String := "KiCad Legacy Layout,Eagle";
   K_866           : aliased constant String := "ph";
   M_866           : aliased constant String := "Perl";
   K_867           : aliased constant String := "pascal";
   M_867           : aliased constant String := "Pascal";
   K_868           : aliased constant String := "omgrofl";
   M_868           : aliased constant String := "Omgrofl";
   K_869           : aliased constant String := "fan";
   M_869           : aliased constant String := "Fantom";
   K_870           : aliased constant String := "pl";
   M_870           : aliased constant String := "Perl,Raku,Prolog";
   K_871           : aliased constant String := "pml";
   M_871           : aliased constant String := "Promela";
   K_872           : aliased constant String := "polar";
   M_872           : aliased constant String := "Polar";
   K_873           : aliased constant String := "pm";
   M_873           : aliased constant String := "Perl,X PixMap,Raku";
   K_874           : aliased constant String := "po";
   M_874           : aliased constant String := "Gettext Catalog";
   K_875           : aliased constant String := "pp";
   M_875           : aliased constant String := "Puppet,Pascal";
   K_876           : aliased constant String := "latte";
   M_876           : aliased constant String := "Latte";
   K_877           : aliased constant String := "bro";
   M_877           : aliased constant String := "Zeek";
   K_878           : aliased constant String := "ps";
   M_878           : aliased constant String := "PostScript";
   K_879           : aliased constant String := "asmx";
   M_879           : aliased constant String := "ASP.NET";
   K_880           : aliased constant String := "pt";
   M_880           : aliased constant String := "XML";
   K_881           : aliased constant String := "brs";
   M_881           : aliased constant String := "Brightscript";
   K_882           : aliased constant String := "py";
   M_882           : aliased constant String := "Python";
   K_883           : aliased constant String := "xpl";
   M_883           : aliased constant String := "XProc";
   K_884           : aliased constant String := "xpm";
   M_884           : aliased constant String := "X PixMap";
   K_885           : aliased constant String := "cfc";
   M_885           : aliased constant String := "ColdFusion CFC";
   K_886           : aliased constant String := "sjs";
   M_886           : aliased constant String := "JavaScript";
   K_887           : aliased constant String := "mrc";
   M_887           : aliased constant String := "mIRC Script";
   K_888           : aliased constant String := "cfg";
   M_888           : aliased constant String := "INI,HAProxy";
   K_889           : aliased constant String := "muse";
   M_889           : aliased constant String := "Muse";
   K_890           : aliased constant String := "edge";
   M_890           : aliased constant String := "Edge";
   K_891           : aliased constant String := "phps";
   M_891           : aliased constant String := "PHP";
   K_892           : aliased constant String := "phpt";
   M_892           : aliased constant String := "PHP";
   K_893           : aliased constant String := "regex";
   M_893           : aliased constant String := "Regular Expression";
   K_894           : aliased constant String := "Dsr";
   M_894           : aliased constant String := "Visual Basic 6.0";
   K_895           : aliased constant String := "xpy";
   M_895           : aliased constant String := "Python";
   K_896           : aliased constant String := "cfm";
   M_896           : aliased constant String := "ColdFusion";
   K_897           : aliased constant String := "twig";
   M_897           : aliased constant String := "Twig";
   K_898           : aliased constant String := "rb";
   M_898           : aliased constant String := "Ruby";
   K_899           : aliased constant String := "kid";
   M_899           : aliased constant String := "Genshi";
   K_900           : aliased constant String := "capnp";
   M_900           : aliased constant String := "Cap'n Proto";
   K_901           : aliased constant String := "blade";
   M_901           : aliased constant String := "Blade";
   K_902           : aliased constant String := "pod";
   M_902           : aliased constant String := "Pod 6,Pod";
   K_903           : aliased constant String := "rd";
   M_903           : aliased constant String := "R";
   K_904           : aliased constant String := "re";
   M_904           : aliased constant String := "C++,Reason";
   K_905           : aliased constant String := "rg";
   M_905           : aliased constant String := "Rouge";
   K_906           : aliased constant String := "anim";
   M_906           : aliased constant String := "Unity3D Asset";
   K_907           : aliased constant String := "JSON-tmLanguage";
   M_907           : aliased constant String := "JSON";
   K_908           : aliased constant String := "rl";
   M_908           : aliased constant String := "Ragel";
   K_909           : aliased constant String := "sparql";
   M_909           : aliased constant String := "SPARQL";
   K_910           : aliased constant String := "es6";
   M_910           : aliased constant String := "JavaScript";
   K_911           : aliased constant String := "rq";
   M_911           : aliased constant String := "SPARQL";
   K_912           : aliased constant String := "sld";
   M_912           : aliased constant String := "Scheme";
   K_913           : aliased constant String := "por";
   M_913           : aliased constant String := "Portugol";
   K_914           : aliased constant String := "kit";
   M_914           : aliased constant String := "Kit";
   K_915           : aliased constant String := "rs";
   M_915           : aliased constant String := "XML,Rust,RenderScript";
   K_916           : aliased constant String := "pot";
   M_916           : aliased constant String := "Gettext Catalog";
   K_917           : aliased constant String := "sublime-settings";
   M_917           : aliased constant String := "JSON with Comments";
   K_918           : aliased constant String := "ru";
   M_918           : aliased constant String := "Ruby";
   K_919           : aliased constant String := "pov";
   M_919           : aliased constant String := "POV-Ray SDL";
   K_920           : aliased constant String := "swift";
   M_920           : aliased constant String := "Swift";
   K_921           : aliased constant String := "xrl";
   M_921           : aliased constant String := "Erlang";
   K_922           : aliased constant String := "sln";
   M_922           : aliased constant String := "Microsoft Visual Studio Solution";
   K_923           : aliased constant String := "blade.php";
   M_923           : aliased constant String := "Blade";
   K_924           : aliased constant String := "sls";
   M_924           : aliased constant String := "Scheme,SaltStack";
   K_925           : aliased constant String := "rbuild";
   M_925           : aliased constant String := "Ruby";
   K_926           : aliased constant String := "xsjslib";
   M_926           : aliased constant String := "JavaScript";
   K_927           : aliased constant String := "talon";
   M_927           : aliased constant String := "Talon";
   K_928           : aliased constant String := "mligo";
   M_928           : aliased constant String := "CameLIGO";
   K_929           : aliased constant String := "mkii";
   M_929           : aliased constant String := "TeX";
   K_930           : aliased constant String := "SchDoc";
   M_930           : aliased constant String := "Altium Designer";
   K_931           : aliased constant String := "ps1";
   M_931           : aliased constant String := "PowerShell";
   K_932           : aliased constant String := "vim";
   M_932           : aliased constant String := "Vim Script";
   K_933           : aliased constant String := "nims";
   M_933           : aliased constant String := "Nim";
   K_934           : aliased constant String := "fea";
   M_934           : aliased constant String := "OpenType Feature File";
   K_935           : aliased constant String := "json";
   M_935           : aliased constant String := "JSON,OASv3-json,OASv2-json";
   K_936           : aliased constant String := "mtl";
   M_936           : aliased constant String := "Wavefront Material";
   K_937           : aliased constant String := "unity";
   M_937           : aliased constant String := "Unity3D Asset";
   K_938           : aliased constant String := "wast";
   M_938           : aliased constant String := "WebAssembly";
   K_939           : aliased constant String := "chs";
   M_939           : aliased constant String := "C2hs Haskell";
   K_940           : aliased constant String := "kojo";
   M_940           : aliased constant String := "Scala";
   K_941           : aliased constant String := "te";
   M_941           : aliased constant String := "SELinux Policy";
   K_942           : aliased constant String := "mts";
   M_942           : aliased constant String := "TypeScript";
   K_943           : aliased constant String := "pact";
   M_943           : aliased constant String := "Pact";
   K_944           : aliased constant String := "tf";
   M_944           : aliased constant String := "HCL";
   K_945           : aliased constant String := "viw";
   M_945           : aliased constant String := "SQL";
   K_946           : aliased constant String := "mkiv";
   M_946           : aliased constant String := "TeX";
   K_947           : aliased constant String := "tres";
   M_947           : aliased constant String := "Godot Resource";
   K_948           : aliased constant String := "yaml-tmlanguage";
   M_948           : aliased constant String := "YAML";
   K_949           : aliased constant String := "tl";
   M_949           : aliased constant String := "Type Language";
   K_950           : aliased constant String := "rhtml";
   M_950           : aliased constant String := "HTML+ERB";
   K_951           : aliased constant String := "stan";
   M_951           : aliased constant String := "Stan";
   K_952           : aliased constant String := "tm";
   M_952           : aliased constant String := "Tcl";
   K_953           : aliased constant String := "numsc";
   M_953           : aliased constant String := "NumPy";
   K_954           : aliased constant String := "star";
   M_954           : aliased constant String := "Starlark,STAR";
   K_955           : aliased constant String := "xojo_report";
   M_955           : aliased constant String := "Xojo";
   K_956           : aliased constant String := "ts";
   M_956           : aliased constant String := "XML,TypeScript";
   K_957           : aliased constant String := "gemspec";
   M_957           : aliased constant String := "Ruby";
   K_958           : aliased constant String := "tu";
   M_958           : aliased constant String := "Turing";
   K_959           : aliased constant String := "yacc";
   M_959           : aliased constant String := "Yacc";
   K_960           : aliased constant String := "cl2";
   M_960           : aliased constant String := "Clojure";
   K_961           : aliased constant String := "minid";
   M_961           : aliased constant String := "MiniD";
   K_962           : aliased constant String := "bison";
   M_962           : aliased constant String := "Bison";
   K_963           : aliased constant String := "snip";
   M_963           : aliased constant String := "Vim Snippet";
   K_964           : aliased constant String := "dockerfile";
   M_964           : aliased constant String := "Dockerfile";
   K_965           : aliased constant String := "tmac";
   M_965           : aliased constant String := "Roff";
   K_966           : aliased constant String := "sha384";
   M_966           : aliased constant String := "Checksums";
   K_967           : aliased constant String := "xspec";
   M_967           : aliased constant String := "XML";
   K_968           : aliased constant String := "trigger";
   M_968           : aliased constant String := "Shell,Apex";
   K_969           : aliased constant String := "hpp";
   M_969           : aliased constant String := "C++";
   K_970           : aliased constant String := "vb";
   M_970           : aliased constant String := "Visual Basic .NET";
   K_971           : aliased constant String := "fxml";
   M_971           : aliased constant String := "XML";
   K_972           : aliased constant String := "psc";
   M_972           : aliased constant String := "Papyrus";
   K_973           : aliased constant String := "cjs";
   M_973           : aliased constant String := "JavaScript";
   K_974           : aliased constant String := "iuml";
   M_974           : aliased constant String := "PlantUML";
   K_975           : aliased constant String := "vh";
   M_975           : aliased constant String := "SystemVerilog";
   K_976           : aliased constant String := "bash";
   M_976           : aliased constant String := "Shell";
   K_977           : aliased constant String := "kml";
   M_977           : aliased constant String := "XML";
   K_978           : aliased constant String := "wlua";
   M_978           : aliased constant String := "Lua";
   K_979           : aliased constant String := "eliom";
   M_979           : aliased constant String := "OCaml";
   K_980           : aliased constant String := "idc";
   M_980           : aliased constant String := "C";
   K_981           : aliased constant String := "spc";
   M_981           : aliased constant String := "PLSQL";
   K_982           : aliased constant String := "jade";
   M_982           : aliased constant String := "Pug";
   K_983           : aliased constant String := "jslib";
   M_983           : aliased constant String := "JavaScript";
   K_984           : aliased constant String := "vs";
   M_984           : aliased constant String := "GLSL";
   K_985           : aliased constant String := "hlean";
   M_985           : aliased constant String := "Lean";
   K_986           : aliased constant String := "njk";
   M_986           : aliased constant String := "Nunjucks";
   K_987           : aliased constant String := "vw";
   M_987           : aliased constant String := "PLSQL";
   K_988           : aliased constant String := "vy";
   M_988           : aliased constant String := "Vyper";
   K_989           : aliased constant String := "pod6";
   M_989           : aliased constant String := "Pod 6";
   K_990           : aliased constant String := "vmb";
   M_990           : aliased constant String := "Vim Script";
   K_991           : aliased constant String := "idr";
   M_991           : aliased constant String := "Idris";
   K_992           : aliased constant String := "njs";
   M_992           : aliased constant String := "JavaScript";
   K_993           : aliased constant String := "sps";
   M_993           : aliased constant String := "Scheme";
   K_994           : aliased constant String := "clj";
   M_994           : aliased constant String := "Clojure";
   K_995           : aliased constant String := "html.hl";
   M_995           : aliased constant String := "HTML";
   K_996           : aliased constant String := "hrl";
   M_996           : aliased constant String := "Erlang";
   K_997           : aliased constant String := "las";
   M_997           : aliased constant String := "Lasso";
   K_998           : aliased constant String := "nim.cfg";
   M_998           : aliased constant String := "Nim";
   K_999           : aliased constant String := "clp";
   M_999           : aliased constant String := "CLIPS";
   K_1000          : aliased constant String := "haml";
   M_1000          : aliased constant String := "Haml";
   K_1001          : aliased constant String := "pub";
   M_1001          : aliased constant String := "Public Key";
   K_1002          : aliased constant String := "xc";
   M_1002          : aliased constant String := "XC";
   K_1003          : aliased constant String := "cls";
   M_1003          : aliased constant String := "VBA,Visual Basic 6.0,TeX,OpenEdge ABL,Obj"
       & "ectScript,Apex";
   K_1004          : aliased constant String := "gypi";
   M_1004          : aliased constant String := "Python";
   K_1005          : aliased constant String := "mxt";
   M_1005          : aliased constant String := "Max";
   K_1006          : aliased constant String := "db2";
   M_1006          : aliased constant String := "SQLPL";
   K_1007          : aliased constant String := "pug";
   M_1007          : aliased constant String := "Pug";
   K_1008          : aliased constant String := "clw";
   M_1008          : aliased constant String := "Clarion";
   K_1009          : aliased constant String := "xi";
   M_1009          : aliased constant String := "Logos";
   K_1010          : aliased constant String := "grxml";
   M_1010          : aliased constant String := "XML";
   K_1011          : aliased constant String := "pddl";
   M_1011          : aliased constant String := "PDDL";
   K_1012          : aliased constant String := "xm";
   M_1012          : aliased constant String := "Logos";
   K_1013          : aliased constant String := "sra";
   M_1013          : aliased constant String := "PowerBuilder";
   K_1014          : aliased constant String := "diff";
   M_1014          : aliased constant String := "Diff";
   K_1015          : aliased constant String := "bzl";
   M_1015          : aliased constant String := "Starlark";
   K_1016          : aliased constant String := "rbres";
   M_1016          : aliased constant String := "REALbasic";
   K_1017          : aliased constant String := "chem";
   M_1017          : aliased constant String := "Pic";
   K_1018          : aliased constant String := "xq";
   M_1018          : aliased constant String := "XQuery";
   K_1019          : aliased constant String := "groovy";
   M_1019          : aliased constant String := "Groovy";
   K_1020          : aliased constant String := "dhall";
   M_1020          : aliased constant String := "Dhall";
   K_1021          : aliased constant String := "xs";
   M_1021          : aliased constant String := "XS";
   K_1022          : aliased constant String := "nimble";
   M_1022          : aliased constant String := "Nim";
   K_1023          : aliased constant String := "lslp";
   M_1023          : aliased constant String := "LSL";
   K_1024          : aliased constant String := "marko";
   M_1024          : aliased constant String := "Marko";
   K_1025          : aliased constant String := "wat";
   M_1025          : aliased constant String := "WebAssembly";
   K_1026          : aliased constant String := "hta";
   M_1026          : aliased constant String := "HTML";
   K_1027          : aliased constant String := "rbbas";
   M_1027          : aliased constant String := "REALbasic";
   K_1028          : aliased constant String := "cnc";
   M_1028          : aliased constant String := "G-code";
   K_1029          : aliased constant String := "srt";
   M_1029          : aliased constant String := "SubRip Text,SRecode Template";
   K_1030          : aliased constant String := "cnf";
   M_1030          : aliased constant String := "INI";
   K_1031          : aliased constant String := "ob2";
   M_1031          : aliased constant String := "Oberon";
   K_1032          : aliased constant String := "sru";
   M_1032          : aliased constant String := "PowerBuilder";
   K_1033          : aliased constant String := "sexp";
   M_1033          : aliased constant String := "Common Lisp";
   K_1034          : aliased constant String := "srw";
   M_1034          : aliased constant String := "PowerBuilder";
   K_1035          : aliased constant String := "maxpat";
   M_1035          : aliased constant String := "Max";
   K_1036          : aliased constant String := "py3";
   M_1036          : aliased constant String := "Python";
   K_1037          : aliased constant String := "htm";
   M_1037          : aliased constant String := "HTML";
   K_1038          : aliased constant String := "editorconfig";
   M_1038          : aliased constant String := "EditorConfig";
   K_1039          : aliased constant String := "angelscript";
   M_1039          : aliased constant String := "AngelScript";
   K_1040          : aliased constant String := "vala";
   M_1040          : aliased constant String := "Vala";
   K_1041          : aliased constant String := "zeek";
   M_1041          : aliased constant String := "Zeek";
   K_1042          : aliased constant String := "jison";
   M_1042          : aliased constant String := "Jison";
   K_1043          : aliased constant String := "kql";
   M_1043          : aliased constant String := "Kusto";
   K_1044          : aliased constant String := "fcgi";
   M_1044          : aliased constant String := "Python,Perl,Lua,Shell,Ruby,PHP";
   K_1045          : aliased constant String := "pwn";
   M_1045          : aliased constant String := "Pawn";
   K_1046          : aliased constant String := "factor";
   M_1046          : aliased constant String := "Factor";
   K_1047          : aliased constant String := "zs";
   M_1047          : aliased constant String := "ZenScript";
   K_1048          : aliased constant String := "rabl";
   M_1048          : aliased constant String := "Ruby";
   K_1049          : aliased constant String := "eye";
   M_1049          : aliased constant String := "Ruby";
   K_1050          : aliased constant String := "wgsl";
   M_1050          : aliased constant String := "WGSL";
   K_1051          : aliased constant String := "cljscm";
   M_1051          : aliased constant String := "Clojure";
   K_1052          : aliased constant String := "stl";
   M_1052          : aliased constant String := "STL";
   K_1053          : aliased constant String := "vssettings";
   M_1053          : aliased constant String := "XML";
   K_1054          : aliased constant String := "less";
   M_1054          : aliased constant String := "Less";
   K_1055          : aliased constant String := "plist";
   M_1055          : aliased constant String := "XML Property List,OpenStep Property List";
   K_1056          : aliased constant String := "PcbDoc";
   M_1056          : aliased constant String := "Altium Designer";
   K_1057          : aliased constant String := "litcoffee";
   M_1057          : aliased constant String := "Literate CoffeeScript";
   K_1058          : aliased constant String := "vcxproj";
   M_1058          : aliased constant String := "XML";
   K_1059          : aliased constant String := "sty";
   M_1059          : aliased constant String := "TeX";
   K_1060          : aliased constant String := "sha256sum";
   M_1060          : aliased constant String := "Checksums";
   K_1061          : aliased constant String := "circom";
   M_1061          : aliased constant String := "Circom";
   K_1062          : aliased constant String := "agc";
   M_1062          : aliased constant String := "Apollo Guidance Computer";
   K_1063          : aliased constant String := "cpp";
   M_1063          : aliased constant String := "C++";
   K_1064          : aliased constant String := "sagews";
   M_1064          : aliased constant String := "Sage";
   K_1065          : aliased constant String := "cps";
   M_1065          : aliased constant String := "Component Pascal";
   K_1066          : aliased constant String := "obj";
   M_1066          : aliased constant String := "Wavefront Object";
   K_1067          : aliased constant String := "lex";
   M_1067          : aliased constant String := "Lex";
   K_1068          : aliased constant String := "OutJob";
   M_1068          : aliased constant String := "Altium Designer";
   K_1069          : aliased constant String := "lkml";
   M_1069          : aliased constant String := "LookML";
   K_1070          : aliased constant String := "ksh";
   M_1070          : aliased constant String := "Shell";
   K_1071          : aliased constant String := "agda";
   M_1071          : aliased constant String := "Agda";
   K_1072          : aliased constant String := "gaml";
   M_1072          : aliased constant String := "GAML";
   K_1073          : aliased constant String := "pyi";
   M_1073          : aliased constant String := "Python";
   K_1074          : aliased constant String := "cpy";
   M_1074          : aliased constant String := "COBOL";
   K_1075          : aliased constant String := "stTheme";
   M_1075          : aliased constant String := "XML Property List";
   K_1076          : aliased constant String := "x68";
   M_1076          : aliased constant String := "Motorola 68K Assembly";
   K_1077          : aliased constant String := "jflex";
   M_1077          : aliased constant String := "JFlex";
   K_1078          : aliased constant String := "pyp";
   M_1078          : aliased constant String := "Python";
   K_1079          : aliased constant String := "emberscript";
   M_1079          : aliased constant String := "EmberScript";
   K_1080          : aliased constant String := "pyt";
   M_1080          : aliased constant String := "Python";
   K_1081          : aliased constant String := "svg";
   M_1081          : aliased constant String := "SVG";
   K_1082          : aliased constant String := "thy";
   M_1082          : aliased constant String := "Isabelle";
   K_1083          : aliased constant String := "svh";
   M_1083          : aliased constant String := "SystemVerilog";
   K_1084          : aliased constant String := "ddl";
   M_1084          : aliased constant String := "SQL,PLSQL";
   K_1085          : aliased constant String := "lidr";
   M_1085          : aliased constant String := "Idris";
   K_1086          : aliased constant String := "pyw";
   M_1086          : aliased constant String := "Python";
   K_1087          : aliased constant String := "ijm";
   M_1087          : aliased constant String := "ImageJ Macro";
   K_1088          : aliased constant String := "ksy";
   M_1088          : aliased constant String := "Kaitai Struct";
   K_1089          : aliased constant String := "conll";
   M_1089          : aliased constant String := "CoNLL-U";
   K_1090          : aliased constant String := "pyx";
   M_1090          : aliased constant String := "Cython";
   K_1091          : aliased constant String := "html.leex";
   M_1091          : aliased constant String := "HTML+EEX";
   K_1092          : aliased constant String := "wsgi";
   M_1092          : aliased constant String := "Python";
   K_1093          : aliased constant String := "props";
   M_1093          : aliased constant String := "XML";
   K_1094          : aliased constant String := "storyboard";
   M_1094          : aliased constant String := "XML";
   K_1095          : aliased constant String := "workflow";
   M_1095          : aliased constant String := "XML,HCL";
   K_1096          : aliased constant String := "qmd";
   M_1096          : aliased constant String := "RMarkdown";
   K_1097          : aliased constant String := "tmPreferences";
   M_1097          : aliased constant String := "XML Property List";
   K_1098          : aliased constant String := "json5";
   M_1098          : aliased constant String := "JSON5";
   K_1099          : aliased constant String := "ijs";
   M_1099          : aliased constant String := "J";
   K_1100          : aliased constant String := "pytb";
   M_1100          : aliased constant String := "Python traceback";
   K_1101          : aliased constant String := "antlers.php";
   M_1101          : aliased constant String := "Antlers";
   K_1102          : aliased constant String := "vsh";
   M_1102          : aliased constant String := "GLSL";
   K_1103          : aliased constant String := "ihlp";
   M_1103          : aliased constant String := "Stata";
   K_1104          : aliased constant String := "qml";
   M_1104          : aliased constant String := "QML";
   K_1105          : aliased constant String := "gap";
   M_1105          : aliased constant String := "GAP";
   K_1106          : aliased constant String := "odd";
   M_1106          : aliased constant String := "XML";
   K_1107          : aliased constant String := "tftpl";
   M_1107          : aliased constant String := "Terraform Template";
   K_1108          : aliased constant String := "lgt";
   M_1108          : aliased constant String := "Logtalk";
   K_1109          : aliased constant String := "http";
   M_1109          : aliased constant String := "HTTP";
   K_1110          : aliased constant String := "gtpl";
   M_1110          : aliased constant String := "Groovy";
   K_1111          : aliased constant String := "eliomi";
   M_1111          : aliased constant String := "OCaml";
   K_1112          : aliased constant String := "rexx";
   M_1112          : aliased constant String := "REXX";
   K_1113          : aliased constant String := "scss";
   M_1113          : aliased constant String := "SCSS";
   K_1114          : aliased constant String := "hxx";
   M_1114          : aliased constant String := "C++";
   K_1115          : aliased constant String := "scenic";
   M_1115          : aliased constant String := "Scenic";
   K_1116          : aliased constant String := "vapi";
   M_1116          : aliased constant String := "Vala";
   K_1117          : aliased constant String := "lasso8";
   M_1117          : aliased constant String := "Lasso";
   K_1118          : aliased constant String := "lasso9";
   M_1118          : aliased constant String := "Lasso";
   K_1119          : aliased constant String := "for";
   M_1119          : aliased constant String := "Fortran,Forth,Formatted";
   K_1120          : aliased constant String := "cpp-objdump";
   M_1120          : aliased constant String := "Cpp-ObjDump";
   K_1121          : aliased constant String := "rockspec";
   M_1121          : aliased constant String := "Lua";
   K_1122          : aliased constant String := "cginc";
   M_1122          : aliased constant String := "HLSL";
   K_1123          : aliased constant String := "ps1xml";
   M_1123          : aliased constant String := "XML";
   K_1124          : aliased constant String := "metal";
   M_1124          : aliased constant String := "Metal";
   K_1125          : aliased constant String := "dfm";
   M_1125          : aliased constant String := "Pascal";
   K_1126          : aliased constant String := "pd_lua";
   M_1126          : aliased constant String := "Lua";
   K_1127          : aliased constant String := "prawn";
   M_1127          : aliased constant String := "Ruby";
   K_1128          : aliased constant String := "prefs";
   M_1128          : aliased constant String := "INI";
   K_1129          : aliased constant String := "lid";
   M_1129          : aliased constant String := "Dylan";
   K_1130          : aliased constant String := "hlsl";
   M_1130          : aliased constant String := "HLSL";
   K_1131          : aliased constant String := "glslf";
   M_1131          : aliased constant String := "GLSL";
   K_1132          : aliased constant String := "raw";
   M_1132          : aliased constant String := "Raw token data";
   K_1133          : aliased constant String := "snippets";
   M_1133          : aliased constant String := "Vim Snippet";
   K_1134          : aliased constant String := "tscn";
   M_1134          : aliased constant String := "Godot Resource";
   K_1135          : aliased constant String := "yaml";
   M_1135          : aliased constant String := "YAML,OASv3-yaml,OASv2-yaml,MiniYAML";
   K_1136          : aliased constant String := "sublime-snippet";
   M_1136          : aliased constant String := "XML";
   K_1137          : aliased constant String := "vue";
   M_1137          : aliased constant String := "Vue";
   K_1138          : aliased constant String := "jsonc";
   M_1138          : aliased constant String := "JSON with Comments";
   K_1139          : aliased constant String := "dfy";
   M_1139          : aliased constant String := "Dafny";
   K_1140          : aliased constant String := "ily";
   M_1140          : aliased constant String := "LilyPond";
   K_1141          : aliased constant String := "gco";
   M_1141          : aliased constant String := "G-code";
   K_1142          : aliased constant String := "tla";
   M_1142          : aliased constant String := "TLA";
   K_1143          : aliased constant String := "ctl";
   M_1143          : aliased constant String := "Visual Basic 6.0";
   K_1144          : aliased constant String := "yaml.sed";
   M_1144          : aliased constant String := "YAML";
   K_1145          : aliased constant String := "jsonl";
   M_1145          : aliased constant String := "JSON";
   K_1146          : aliased constant String := "antlers.xml";
   M_1146          : aliased constant String := "Antlers";
   K_1147          : aliased constant String := "ctp";
   M_1147          : aliased constant String := "PHP";
   K_1148          : aliased constant String := "glslv";
   M_1148          : aliased constant String := "GLSL";
   K_1149          : aliased constant String := "hzp";
   M_1149          : aliased constant String := "XML";
   K_1150          : aliased constant String := "cts";
   M_1150          : aliased constant String := "TypeScript";
   K_1151          : aliased constant String := "bbappend";
   M_1151          : aliased constant String := "BitBake";
   K_1152          : aliased constant String := "nginx";
   M_1152          : aliased constant String := "Nginx";
   K_1153          : aliased constant String := "yrl";
   M_1153          : aliased constant String := "Erlang";
   K_1154          : aliased constant String := "golo";
   M_1154          : aliased constant String := "Golo";
   K_1155          : aliased constant String := "phtml";
   M_1155          : aliased constant String := "HTML+PHP";
   K_1156          : aliased constant String := "inc";
   M_1156          : aliased constant String := "C++,Assembly,SourcePawn,SQL,Pawn,Pascal,P"
       & "OV-Ray SDL,PHP,NASL,Motorola 68K Assembly,HTML,BitBake";
   K_1157          : aliased constant String := "rktd";
   M_1157          : aliased constant String := "Racket";
   K_1158          : aliased constant String := "vark";
   M_1158          : aliased constant String := "Gosu";
   K_1159          : aliased constant String := "mata";
   M_1159          : aliased constant String := "Stata";
   K_1160          : aliased constant String := "sh-session";
   M_1160          : aliased constant String := "ShellSession";
   K_1161          : aliased constant String := "srdf";
   M_1161          : aliased constant String := "XML";
   K_1162          : aliased constant String := "tlv";
   M_1162          : aliased constant String := "TL-Verilog";
   K_1163          : aliased constant String := "shader";
   M_1163          : aliased constant String := "ShaderLab,GLSL";
   K_1164          : aliased constant String := "ini";
   M_1164          : aliased constant String := "INI";
   K_1165          : aliased constant String := "snippet";
   M_1165          : aliased constant String := "Vim Snippet";
   K_1166          : aliased constant String := "maxhelp";
   M_1166          : aliased constant String := "Max";
   K_1167          : aliased constant String := "ink";
   M_1167          : aliased constant String := "Ink";
   K_1168          : aliased constant String := "esdl";
   M_1168          : aliased constant String := "EdgeQL";
   K_1169          : aliased constant String := "rktl";
   M_1169          : aliased constant String := "Racket";
   K_1170          : aliased constant String := "vstemplate";
   M_1170          : aliased constant String := "XML";
   K_1171          : aliased constant String := "inl";
   M_1171          : aliased constant String := "C++";
   K_1172          : aliased constant String := "proto";
   M_1172          : aliased constant String := "Protocol Buffer";
   K_1173          : aliased constant String := "rebol";
   M_1173          : aliased constant String := "Rebol";
   K_1174          : aliased constant String := "syntax";
   M_1174          : aliased constant String := "YAML";
   K_1175          : aliased constant String := "vbhtml";
   M_1175          : aliased constant String := "Visual Basic .NET";
   K_1176          : aliased constant String := "webapp";
   M_1176          : aliased constant String := "JSON";
   K_1177          : aliased constant String := "ino";
   M_1177          : aliased constant String := "C++";
   K_1178          : aliased constant String := "ged";
   M_1178          : aliased constant String := "GEDCOM";
   K_1179          : aliased constant String := "wit";
   M_1179          : aliased constant String := "WebAssembly Interface Type";
   K_1180          : aliased constant String := "gdns";
   M_1180          : aliased constant String := "Godot Resource";
   K_1181          : aliased constant String := "mlir";
   M_1181          : aliased constant String := "MLIR";
   K_1182          : aliased constant String := "regexp";
   M_1182          : aliased constant String := "Regular Expression";
   K_1183          : aliased constant String := "ins";
   M_1183          : aliased constant String := "TeX";
   K_1184          : aliased constant String := "prefab";
   M_1184          : aliased constant String := "Unity3D Asset";
   K_1185          : aliased constant String := "rpgle";
   M_1185          : aliased constant String := "RPGLE";
   K_1186          : aliased constant String := "cppm";
   M_1186          : aliased constant String := "C++";
   K_1187          : aliased constant String := "thrift";
   M_1187          : aliased constant String := "Thrift";
   K_1188          : aliased constant String := "boot";
   M_1188          : aliased constant String := "Clojure";
   K_1189          : aliased constant String := "coffee.md";
   M_1189          : aliased constant String := "Literate CoffeeScript";
   K_1190          : aliased constant String := "plot";
   M_1190          : aliased constant String := "Gnuplot";
   K_1191          : aliased constant String := "gradle.kts";
   M_1191          : aliased constant String := "Gradle Kotlin DSL";
   K_1192          : aliased constant String := "8xp.txt";
   M_1192          : aliased constant String := "TI Program";
   K_1193          : aliased constant String := "geo";
   M_1193          : aliased constant String := "GLSL";
   K_1194          : aliased constant String := "ebuild";
   M_1194          : aliased constant String := "Gentoo Ebuild";
   K_1195          : aliased constant String := "sublime-workspace";
   M_1195          : aliased constant String := "JSON with Comments";
   K_1196          : aliased constant String := "adml";
   M_1196          : aliased constant String := "XML";
   K_1197          : aliased constant String := "fsh";
   M_1197          : aliased constant String := "GLSL";
   K_1198          : aliased constant String := "ebnf";
   M_1198          : aliased constant String := "EBNF";
   K_1199          : aliased constant String := "fsi";
   M_1199          : aliased constant String := "F#";
   K_1200          : aliased constant String := "reb";
   M_1200          : aliased constant String := "Rebol";
   K_1201          : aliased constant String := "red";
   M_1201          : aliased constant String := "Red";
   K_1202          : aliased constant String := "bicepparam";
   M_1202          : aliased constant String := "Bicep";
   K_1203          : aliased constant String := "ston";
   M_1203          : aliased constant String := "STON";
   K_1204          : aliased constant String := "c++-objdump";
   M_1204          : aliased constant String := "Cpp-ObjDump";
   K_1205          : aliased constant String := "reg";
   M_1205          : aliased constant String := "Windows Registry Entries";
   K_1206          : aliased constant String := "rei";
   M_1206          : aliased constant String := "Reason";
   K_1207          : aliased constant String := "ipf";
   M_1207          : aliased constant String := "IGOR Pro";
   K_1208          : aliased constant String := "admx";
   M_1208          : aliased constant String := "XML";
   K_1209          : aliased constant String := "fst";
   M_1209          : aliased constant String := "F*";
   K_1210          : aliased constant String := "mint";
   M_1210          : aliased constant String := "Mint";
   K_1211          : aliased constant String := "zmpl";
   M_1211          : aliased constant String := "Zimpl";
   K_1212          : aliased constant String := "wixproj";
   M_1212          : aliased constant String := "XML";
   K_1213          : aliased constant String := "fsx";
   M_1213          : aliased constant String := "F#";
   K_1214          : aliased constant String := "desktop.in";
   M_1214          : aliased constant String := "desktop";
   K_1215          : aliased constant String := "libsonnet";
   M_1215          : aliased constant String := "Jsonnet";
   K_1216          : aliased constant String := "res";
   M_1216          : aliased constant String := "XML,ReScript";
   K_1217          : aliased constant String := "sublime-theme";
   M_1217          : aliased constant String := "JSON with Comments";
   K_1218          : aliased constant String := "ipp";
   M_1218          : aliased constant String := "C++";
   K_1219          : aliased constant String := "djs";
   M_1219          : aliased constant String := "Dogescript";
   K_1220          : aliased constant String := "rex";
   M_1220          : aliased constant String := "REXX";
   K_1221          : aliased constant String := "sh.in";
   M_1221          : aliased constant String := "Shell";
   K_1222          : aliased constant String := "vhost";
   M_1222          : aliased constant String := "Nginx,ApacheConf";
   K_1223          : aliased constant String := "app.src";
   M_1223          : aliased constant String := "Erlang";
   K_1224          : aliased constant String := "lmi";
   M_1224          : aliased constant String := "Python";
   K_1225          : aliased constant String := "bal";
   M_1225          : aliased constant String := "Ballerina";
   K_1226          : aliased constant String := "glsl";
   M_1226          : aliased constant String := "GLSL";
   K_1227          : aliased constant String := "xaml";
   M_1227          : aliased constant String := "XML";
   K_1228          : aliased constant String := "adoc";
   M_1228          : aliased constant String := "AsciiDoc";
   K_1229          : aliased constant String := "tpb";
   M_1229          : aliased constant String := "PLSQL";
   K_1230          : aliased constant String := "bas";
   M_1230          : aliased constant String := "VBA,Visual Basic 6.0,FreeBasic,BASIC";
   K_1231          : aliased constant String := "bat";
   M_1231          : aliased constant String := "Batchfile";
   K_1232          : aliased constant String := "pasm";
   M_1232          : aliased constant String := "Parrot Assembly";
   K_1233          : aliased constant String := "duby";
   M_1233          : aliased constant String := "Mirah";
   K_1234          : aliased constant String := "cson";
   M_1234          : aliased constant String := "CSON";
   K_1235          : aliased constant String := "tpl";
   M_1235          : aliased constant String := "Smarty";
   K_1236          : aliased constant String := "pony";
   M_1236          : aliased constant String := "Pony";
   K_1237          : aliased constant String := "cxx";
   M_1237          : aliased constant String := "C++";
   K_1238          : aliased constant String := "tpp";
   M_1238          : aliased constant String := "C++";
   K_1239          : aliased constant String := "fun";
   M_1239          : aliased constant String := "Standard ML";
   K_1240          : aliased constant String := "tps";
   M_1240          : aliased constant String := "PLSQL";
   K_1241          : aliased constant String := "mak";
   M_1241          : aliased constant String := "Makefile";
   K_1242          : aliased constant String := "fut";
   M_1242          : aliased constant String := "Futhark";
   K_1243          : aliased constant String := "man";
   M_1243          : aliased constant String := "Roff Manpage,Roff";
   K_1244          : aliased constant String := "mao";
   M_1244          : aliased constant String := "Mako";
   K_1245          : aliased constant String := "conllu";
   M_1245          : aliased constant String := "CoNLL-U";
   K_1246          : aliased constant String := "dlm";
   M_1246          : aliased constant String := "IDL";
   K_1247          : aliased constant String := "mdown";
   M_1247          : aliased constant String := "Markdown";
   K_1248          : aliased constant String := "mat";
   M_1248          : aliased constant String := "Unity3D Asset";
   K_1249          : aliased constant String := "udf";
   M_1249          : aliased constant String := "SQL";
   K_1250          : aliased constant String := "aj";
   M_1250          : aliased constant String := "AspectJ";
   K_1251          : aliased constant String := "rmiss";
   M_1251          : aliased constant String := "GLSL";
   K_1252          : aliased constant String := "al";
   M_1252          : aliased constant String := "Perl,AL";
   K_1253          : aliased constant String := "xhtml";
   M_1253          : aliased constant String := "HTML";
   K_1254          : aliased constant String := "udo";
   M_1254          : aliased constant String := "Csound";
   K_1255          : aliased constant String := "xquery";
   M_1255          : aliased constant String := "XQuery";
   K_1256          : aliased constant String := "lol";
   M_1256          : aliased constant String := "LOLCODE";
   K_1257          : aliased constant String := "as";
   M_1257          : aliased constant String := "AngelScript,ActionScript";
   K_1258          : aliased constant String := "mojo";
   M_1258          : aliased constant String := "XML,Mojo";
   K_1259          : aliased constant String := "aw";
   M_1259          : aliased constant String := "PHP";
   K_1260          : aliased constant String := "riot";
   M_1260          : aliased constant String := "Riot";
   K_1261          : aliased constant String := "xojo_window";
   M_1261          : aliased constant String := "Xojo";
   K_1262          : aliased constant String := "trg";
   M_1262          : aliased constant String := "PLSQL";
   K_1263          : aliased constant String := "gawk";
   M_1263          : aliased constant String := "Awk";
   K_1264          : aliased constant String := "patch";
   M_1264          : aliased constant String := "Diff";
   K_1265          : aliased constant String := "dita";
   M_1265          : aliased constant String := "XML";
   K_1266          : aliased constant String := "jinja2";
   M_1266          : aliased constant String := "Jinja";
   K_1267          : aliased constant String := "hlsli";
   M_1267          : aliased constant String := "HLSL";
   K_1268          : aliased constant String := "psc1";
   M_1268          : aliased constant String := "XML";
   K_1269          : aliased constant String := "whiley";
   M_1269          : aliased constant String := "Whiley";
   K_1270          : aliased constant String := "cc";
   M_1270          : aliased constant String := "C++";
   K_1271          : aliased constant String := "linq";
   M_1271          : aliased constant String := "C#";
   K_1272          : aliased constant String := "lasso";
   M_1272          : aliased constant String := "Lasso";
   K_1273          : aliased constant String := "vhdl";
   M_1273          : aliased constant String := "VHDL";
   K_1274          : aliased constant String := "mcr";
   M_1274          : aliased constant String := "MAXScript";
   K_1275          : aliased constant String := "ch";
   M_1275          : aliased constant String := "xBase,Charity";
   K_1276          : aliased constant String := "ck";
   M_1276          : aliased constant String := "ChucK";
   K_1277          : aliased constant String := "html.heex";
   M_1277          : aliased constant String := "HTML+EEX";
   K_1278          : aliased constant String := "cl";
   M_1278          : aliased constant String := "OpenCL,Cool,Common Lisp";
   K_1279          : aliased constant String := "smali";
   M_1279          : aliased constant String := "Smali";
   K_1280          : aliased constant String := "dyalog";
   M_1280          : aliased constant String := "APL";
   K_1281          : aliased constant String := "makefile";
   M_1281          : aliased constant String := "Makefile";
   K_1282          : aliased constant String := "cp";
   M_1282          : aliased constant String := "C++,Component Pascal";
   K_1283          : aliased constant String := "xzap";
   M_1283          : aliased constant String := "ZAP";
   K_1284          : aliased constant String := "c-objdump";
   M_1284          : aliased constant String := "C-ObjDump";
   K_1285          : aliased constant String := "cr";
   M_1285          : aliased constant String := "Crystal";
   K_1286          : aliased constant String := "au3";
   M_1286          : aliased constant String := "AutoIt";
   K_1287          : aliased constant String := "gko";
   M_1287          : aliased constant String := "Gerber Image";
   K_1288          : aliased constant String := "cs";
   M_1288          : aliased constant String := "Smalltalk,C#";
   K_1289          : aliased constant String := "hxml";
   M_1289          : aliased constant String := "HXML";
   K_1290          : aliased constant String := "ct";
   M_1290          : aliased constant String := "XML";
   K_1291          : aliased constant String := "mdpolicy";
   M_1291          : aliased constant String := "XML";
   K_1292          : aliased constant String := "cu";
   M_1292          : aliased constant String := "Cuda";
   K_1293          : aliased constant String := "sublime_metrics";
   M_1293          : aliased constant String := "JSON with Comments";
   K_1294          : aliased constant String := "cw";
   M_1294          : aliased constant String := "Redcode";
   K_1295          : aliased constant String := "asc";
   M_1295          : aliased constant String := "Public Key,AsciiDoc,AGS Script";
   K_1296          : aliased constant String := "jscad";
   M_1296          : aliased constant String := "JavaScript";
   K_1297          : aliased constant String := "cy";
   M_1297          : aliased constant String := "Cycript";
   K_1298          : aliased constant String := "asd";
   M_1298          : aliased constant String := "Common Lisp";
   K_1299          : aliased constant String := "ash";
   M_1299          : aliased constant String := "AGS Script";
   K_1300          : aliased constant String := "proj";
   M_1300          : aliased constant String := "XML";
   K_1301          : aliased constant String := "ttl";
   M_1301          : aliased constant String := "Turtle";
   K_1302          : aliased constant String := "applescript";
   M_1302          : aliased constant String := "AppleScript";
   K_1303          : aliased constant String := "asl";
   M_1303          : aliased constant String := "ASL";
   K_1304          : aliased constant String := "sieve";
   M_1304          : aliased constant String := "Sieve";
   K_1305          : aliased constant String := "asm";
   M_1305          : aliased constant String := "Assembly,Motorola 68K Assembly";
   K_1306          : aliased constant String := "liquid";
   M_1306          : aliased constant String := "Liquid";
   K_1307          : aliased constant String := "asn";
   M_1307          : aliased constant String := "ASN.1";
   K_1308          : aliased constant String := "java";
   M_1308          : aliased constant String := "Java";
   K_1309          : aliased constant String := "asp";
   M_1309          : aliased constant String := "Classic ASP";
   K_1310          : aliased constant String := "neon";
   M_1310          : aliased constant String := "NEON";
   K_1311          : aliased constant String := "g4";
   M_1311          : aliased constant String := "ANTLR";
   K_1312          : aliased constant String := "ditaval";
   M_1312          : aliased constant String := "XML";
   K_1313          : aliased constant String := "gcode";
   M_1313          : aliased constant String := "G-code";
   K_1314          : aliased constant String := "nomad";
   M_1314          : aliased constant String := "HCL";
   K_1315          : aliased constant String := "sats";
   M_1315          : aliased constant String := "ATS";
   K_1316          : aliased constant String := "eb";
   M_1316          : aliased constant String := "Easybuild";
   K_1317          : aliased constant String := "asy";
   M_1317          : aliased constant String := "LTspice Symbol,Asymptote";
   K_1318          : aliased constant String := "ec";
   M_1318          : aliased constant String := "eC";
   K_1319          : aliased constant String := "matah";
   M_1319          : aliased constant String := "Stata";
   K_1320          : aliased constant String := "xojo_toolbar";
   M_1320          : aliased constant String := "Xojo";
   K_1321          : aliased constant String := "eh";
   M_1321          : aliased constant String := "eC";
   K_1322          : aliased constant String := "rkt";
   M_1322          : aliased constant String := "Racket";
   K_1323          : aliased constant String := "dpr";
   M_1323          : aliased constant String := "Pascal";
   K_1324          : aliased constant String := "_js";
   M_1324          : aliased constant String := "JavaScript";
   K_1325          : aliased constant String := "pbi";
   M_1325          : aliased constant String := "PureBasic";
   K_1326          : aliased constant String := "el";
   M_1326          : aliased constant String := "Emacs Lisp";
   K_1327          : aliased constant String := "gmi";
   M_1327          : aliased constant String := "Gemini";
   K_1328          : aliased constant String := "em";
   M_1328          : aliased constant String := "EmberScript";
   K_1329          : aliased constant String := "tcl.in";
   M_1329          : aliased constant String := "Tcl";
   K_1330          : aliased constant String := "mcfunction";
   M_1330          : aliased constant String := "mcfunction";
   K_1331          : aliased constant String := "arpa";
   M_1331          : aliased constant String := "DNS Zone";
   K_1332          : aliased constant String := "gml";
   M_1332          : aliased constant String := "XML,Graph Modeling Language,Gerber Image,"
       & "Game Maker Language";
   K_1333          : aliased constant String := "sha256";
   M_1333          : aliased constant String := "Checksums";
   K_1334          : aliased constant String := "lsl";
   M_1334          : aliased constant String := "LSL";
   K_1335          : aliased constant String := "eq";
   M_1335          : aliased constant String := "EQ";
   K_1336          : aliased constant String := "ivy";
   M_1336          : aliased constant String := "XML";
   K_1337          : aliased constant String := "kicad_pcb";
   M_1337          : aliased constant String := "KiCad Layout";
   K_1338          : aliased constant String := "edc";
   M_1338          : aliased constant String := "Edje Data Collection";
   K_1339          : aliased constant String := "es";
   M_1339          : aliased constant String := "JavaScript,Erlang";
   K_1340          : aliased constant String := "opa";
   M_1340          : aliased constant String := "Opa";
   K_1341          : aliased constant String := "mkfile";
   M_1341          : aliased constant String := "Makefile";
   K_1342          : aliased constant String := "pbt";
   M_1342          : aliased constant String := "Protocol Buffer Text Format,PowerBuilder";
   K_1343          : aliased constant String := "cs.pp";
   M_1343          : aliased constant String := "C#";
   K_1344          : aliased constant String := "lsp";
   M_1344          : aliased constant String := "NewLisp,Common Lisp";
   K_1345          : aliased constant String := "gms";
   M_1345          : aliased constant String := "GAMS";
   K_1346          : aliased constant String := "3pm";
   M_1346          : aliased constant String := "Roff Manpage,Roff";
   K_1347          : aliased constant String := "ex";
   M_1347          : aliased constant String := "Elixir,Euphoria";
   K_1348          : aliased constant String := "aug";
   M_1348          : aliased constant String := "Augeas";
   K_1349          : aliased constant String := "gmx";
   M_1349          : aliased constant String := "XML";
   K_1350          : aliased constant String := "edn";
   M_1350          : aliased constant String := "edn";
   K_1351          : aliased constant String := "thor";
   M_1351          : aliased constant String := "Ruby";
   K_1352          : aliased constant String := "auk";
   M_1352          : aliased constant String := "Awk";
   K_1353          : aliased constant String := "jbuilder";
   M_1353          : aliased constant String := "Ruby";
   K_1354          : aliased constant String := "rmd";
   M_1354          : aliased constant String := "RMarkdown";
   K_1355          : aliased constant String := "sublime-keymap";
   M_1355          : aliased constant String := "JSON with Comments";
   K_1356          : aliased constant String := "tmux";
   M_1356          : aliased constant String := "Shell";
   K_1357          : aliased constant String := "wsf";
   M_1357          : aliased constant String := "XML";
   K_1358          : aliased constant String := "i3";
   M_1358          : aliased constant String := "Modula-3";
   K_1359          : aliased constant String := "aux";
   M_1359          : aliased constant String := "TeX";
