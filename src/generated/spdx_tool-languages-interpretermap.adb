...
package body SPDX_Tool.Languages.InterpreterMap is
   ...
   M_14            : aliased constant String := "JavaScript";
   K_15            : aliased constant String := "guile";
   M_15            : aliased constant String := "Scheme";
   K_16            : aliased constant String := "eui";
   M_16            : aliased constant String := "Euphoria";
   K_17            : aliased constant String := "ocamlscript";
   M_17            : aliased constant String := "OCaml";
   K_18            : aliased constant String := "instantfpc";
   M_18            : aliased constant String := "Pascal";
   K_19            : aliased constant String := "rc";
   M_19            : aliased constant String := "Shell";
   K_20            : aliased constant String := "lua";
   M_20            : aliased constant String := "Terra, Lua";
   K_21            : aliased constant String := "swipl";
   M_21            : aliased constant String := "Prolog";
   K_22            : aliased constant String := "ocamlrun";
   M_22            : aliased constant String := "OCaml";
   K_23            : aliased constant String := "v8-shell";
   ...
   K_39            : aliased constant String := "bigloo";
   M_39            : aliased constant String := "Scheme";
   K_40            : aliased constant String := "nush";
   M_40            : aliased constant String := "Nu";
   K_41            : aliased constant String := "rakudo";
   M_41            : aliased constant String := "Raku";
   K_42            : aliased constant String := "dash";
   M_42            : aliased constant String := "Shell";
   K_43            : aliased constant String := "macruby";
   M_43            : aliased constant String := "Ruby";
   K_44            : aliased constant String := "fennel";
   M_44            : aliased constant String := "Fennel";
   K_45            : aliased constant String := "sclang";
   M_45            : aliased constant String := "SuperCollider";
   K_46            : aliased constant String := "perl";
   M_46            : aliased constant String := "Perl, Pod";
   K_47            : aliased constant String := "bash";
   M_47            : aliased constant String := "Shell";
   K_48            : aliased constant String := "wish";
   M_48            : aliased constant String := "Tcl";
   K_49            : aliased constant String := "nawk";
   M_49            : aliased constant String := "Awk";
   K_50            : aliased constant String := "dafny";
   M_50            : aliased constant String := "Dafny";
   K_51            : aliased constant String := "gerbv";
   M_51            : aliased constant String := "Gerber Image";
   K_52            : aliased constant String := "hy";
   M_52            : aliased constant String := "Hy";
   K_53            : aliased constant String := "smt-rat";
   M_53            : aliased constant String := "SMT";
   K_54            : aliased constant String := "openrc-run";
   M_54            : aliased constant String := "OpenRC runscript";
   K_55            : aliased constant String := "gn";
   M_55            : aliased constant String := "GN";
   K_56            : aliased constant String := "pil";
   ...
   M_61            : aliased constant String := "TypeScript";
   K_62            : aliased constant String := "d8";
   M_62            : aliased constant String := "JavaScript";
   K_63            : aliased constant String := "clisp";
   M_63            : aliased constant String := "Common Lisp";
   K_64            : aliased constant String := "chicken";
   M_64            : aliased constant String := "Scheme";
   K_65            : aliased constant String := "RouterOS";
   M_65            : aliased constant String := "RouterOS Script";
   K_66            : aliased constant String := "py";
   M_66            : aliased constant String := "Python";
   K_67            : aliased constant String := "v8";
   ...
   K_80            : aliased constant String := "julia";
   M_80            : aliased constant String := "Julia";
   K_81            : aliased constant String := "ocaml";
   M_81            : aliased constant String := "OCaml, ReScript";
   K_82            : aliased constant String := "fish";
   M_82            : aliased constant String := "fish";
   K_83            : aliased constant String := "qmake";
   ...
   M_98            : aliased constant String := "Haskell";
   K_99            : aliased constant String := "runhaskell";
   M_99            : aliased constant String := "Haskell";
   K_100           : aliased constant String := "ccl";
   M_100           : aliased constant String := "Common Lisp";
   K_101           : aliased constant String := "runghc";
   M_101           : aliased constant String := "Haskell";
   K_102           : aliased constant String := "nu";
   M_102           : aliased constant String := "Nushell";
   K_103           : aliased constant String := "ksh";
   M_103           : aliased constant String := "Shell";
   K_104           : aliased constant String := "cperl";
   M_104           : aliased constant String := "Perl";
   K_105           : aliased constant String := "boogie";
   M_105           : aliased constant String := "Boogie";
   K_106           : aliased constant String := "rbx";
   M_106           : aliased constant String := "Ruby";
   K_107           : aliased constant String := "osascript";
   M_107           : aliased constant String := "AppleScript";
   K_108           : aliased constant String := "cvc4";
   M_108           : aliased constant String := "SMT";
   K_109           : aliased constant String := "raku";
   M_109           : aliased constant String := "Raku";
   K_110           : aliased constant String := "mksh";
   M_110           : aliased constant String := "Shell";
   K_111           : aliased constant String := "deno";
   M_111           : aliased constant String := "TypeScript";
   K_112           : aliased constant String := "r6rs";
   M_112           : aliased constant String := "Scheme";
   K_113           : aliased constant String := "yices2";
   M_113           : aliased constant String := "SMT";
   K_114           : aliased constant String := "aplx";
   M_114           : aliased constant String := "APL";
   K_115           : aliased constant String := "dtrace";
   M_115           : aliased constant String := "DTrace";
   K_116           : aliased constant String := "apl";
   M_116           : aliased constant String := "APL";
   K_117           : aliased constant String := "minised";
   M_117           : aliased constant String := "sed";
   K_118           : aliased constant String := "gnuplot";
   M_118           : aliased constant String := "Gnuplot";
   K_119           : aliased constant String := "mmi";
   M_119           : aliased constant String := "Mercury";
   K_120           : aliased constant String := "coffee";
   M_120           : aliased constant String := "CoffeeScript";
   K_121           : aliased constant String := "scala";
   M_121           : aliased constant String := "Scala";
   K_122           : aliased constant String := "scheme";
   M_122           : aliased constant String := "Scheme";
   K_123           : aliased constant String := "rune";
   M_123           : aliased constant String := "E";
   K_124           : aliased constant String := "gjs";
   M_124           : aliased constant String := "JavaScript";
   K_125           : aliased constant String := "yap";
   M_125           : aliased constant String := "Prolog";
   K_126           : aliased constant String := "opensmt";
   M_126           : aliased constant String := "SMT";
   K_127           : aliased constant String := "gerbview";
   M_127           : aliased constant String := "Gerber Image";
   K_128           : aliased constant String := "csh";
   M_128           : aliased constant String := "Tcsh";
   K_129           : aliased constant String := "perl6";
   M_129           : aliased constant String := "Raku, Pod 6";
   K_130           : aliased constant String := "bb";
   M_130           : aliased constant String := "Clojure";
   K_131           : aliased constant String := "csi";
   M_131           : aliased constant String := "Scheme";
   K_132           : aliased constant String := "make";
   M_132           : aliased constant String := "Makefile";
   K_133           : aliased constant String := "jqjq";
   M_133           : aliased constant String := "jq";
   K_134           : aliased constant String := "cwl-runner";
   M_134           : aliased constant String := "Common Workflow Language";
   K_135           : aliased constant String := "pike";
   M_135           : aliased constant String := "Pike";
   K_136           : aliased constant String := "M2";
   M_136           : aliased constant String := "Macaulay2";
   K_137           : aliased constant String := "tcc";
   M_137           : aliased constant String := "C";
   ...
   M_141           : aliased constant String := "Common Lisp";
   K_142           : aliased constant String := "jaq";
   M_142           : aliased constant String := "jq";
   K_143           : aliased constant String := "sed";
   M_143           : aliased constant String := "sed";
   K_144           : aliased constant String := "boolector";
   M_144           : aliased constant String := "SMT";
   K_145           : aliased constant String := "awk";
   M_145           : aliased constant String := "Awk";
   K_146           : aliased constant String := "ioke";
   M_146           : aliased constant String := "Ioke";
   K_147           : aliased constant String := "rhino";
   M_147           : aliased constant String := "JavaScript";
   K_148           : aliased constant String := "ssed";
   M_148           : aliased constant String := "sed";
   K_149           : aliased constant String := "z3";
   M_149           : aliased constant String := "SMT";
