...
private
   ...
   Rules : aliased constant Rule_Array := (
      ...
      407 => (RULE_SUCCESS, 0, (0, 0), 0, 404),
      408 => (RULE_MATCH, 0, (0, 0), 13, 356),
      409 => (RULE_MATCH, 0, (0, 0), 16, 356),
      410 => (RULE_MATCH, 0, (0, 0), 18, 356),
      411 => (RULE_MATCH, 0, (0, 0), 19, 356),
      412 => (RULE_MATCH, 0, (0, 0), 17, 356),
      413 => (RULE_MATCH, 0, (0, 0), 14, 356),
      414 => (RULE_MATCH, 0, (0, 0), 15, 356),
      415 => (RULE_MATCH, 0, (0, 0), 26, 420),
      416 => (RULE_MATCH, 0, (0, 0), 41, 410),
      417 => (RULE_MATCH, 0, (0, 0), 25, 420),
      418 => (RULE_MATCH, 0, (0, 0), 96, 348),
      419 => (RULE_MATCH, 0, (0, 0), 87, 414),
      420 => (RULE_MATCH, 0, (0, 0), 154, 316),
      421 => (RULE_MATCH, 0, (0, 0), 31, 377),
      422 => (RULE_MATCH, 0, (0, 0), 21, 406),
      423 => (RULE_MATCH, 0, (0, 0), 24, 376),
      424 => (RULE_MATCH, 0, (0, 0), 39, 423),
      425 => (RULE_SUCCESS, 0, (0, 0), 0, 405),
      426 => (RULE_MATCH, 0, (0, 0), 110, 419),
      427 => (RULE_MATCH, 0, (0, 0), 66, 418),
      428 => (RULE_MATCH, 0, (0, 0), 73, 413),
      429 => (RULE_MATCH, 0, (0, 0), 246, 407),
      430 => (RULE_SUCCESS, 0, (0, 0), 0, 417),
      431 => (RULE_MATCH, 0, (0, 0), 76, 408),
      432 => (RULE_MATCH, 0, (0, 0), 180, 421),
      433 => (RULE_MATCH, 0, (0, 0), 210, 441),
      434 => (RULE_SUCCESS, 0, (0, 0), 0, 380),
      435 => (RULE_MATCH_AND, 0, (0, 0), 89, 380),
      436 => (RULE_MATCH_AND, 0, (0, 0), 235, 380),
      437 => (RULE_MATCH_AND, 0, (0, 0), 186, 380),
      438 => (RULE_MATCH_AND, 0, (0, 0), 233, 380),
      439 => (RULE_MATCH, 0, (0, 0), 63, 380),
      440 => (RULE_MATCH, 0, (0, 0), 204, 395),
      441 => (RULE_MATCH, 0, (0, 0), 176, 427),
      442 => (RULE_MATCH, 0, (0, 0), 51, 329),
      443 => (RULE_MATCH, 0, (0, 0), 169, 422),
      444 => (RULE_MATCH, 0, (0, 0), 94, 439),
      445 => (RULE_MATCH, 0, (0, 0), 168, 425),
      446 => (RULE_MATCH, 0, (0, 0), 53, 441),
      447 => (RULE_SUCCESS, 0, (0, 0), 0, 428),
      448 => (RULE_MATCH, 0, (0, 0), 257, 309),
      449 => (RULE_SUCCESS, 0, (0, 0), 0, 411),
      450 => (RULE_MATCH, 0, (0, 0), 194, 424),
      451 => (RULE_MATCH, 0, (0, 0), 38, 441),
      452 => (RULE_MATCH, 0, (0, 0), 10, 435),
      453 => (RULE_MATCH, 0, (0, 0), 20, 268),
      454 => (RULE_SUCCESS, 0, (0, 0), 0, 426),
      455 => (RULE_MATCH, 0, (0, 0), 95, 429),
      456 => (RULE_SUCCESS, 0, (0, 0), 0, 441),
      457 => (RULE_MATCH, 0, (0, 0), 166, 326),
      458 => (RULE_MATCH, 0, (0, 0), 45, 286),
      459 => (RULE_MATCH, 0, (0, 0), 135, 434),
      460 => (RULE_MATCH, 0, (0, 0), 65, 432),
      461 => (RULE_MATCH, 0, (0, 0), 125, 436),
      462 => (RULE_SUCCESS, 0, (0, 0), 0, 433),
      463 => (RULE_MATCH, 0, (0, 0), 6, 373),
      464 => (RULE_MATCH, 0, (0, 0), 121, 282),
      465 => (RULE_MATCH, 0, (0, 0), 254, 289),
      466 => (RULE_MATCH, 0, (0, 0), 85, 393),
      467 => (RULE_MATCH, 0, (0, 0), 98, 339),
      468 => (RULE_MATCH, 0, (0, 0), 60, 337),
      469 => (RULE_MATCH, 0, (0, 0), 237, 352),
      470 => (RULE_MATCH, 0, (0, 0), 262, 364),
      471 => (RULE_MATCH, 0, (0, 0), 259, 366),
      472 => (RULE_SUCCESS, 0, (0, 0), 0, 443),
      473 => (RULE_MATCH, 0, (0, 0), 237, 352),
      474 => (RULE_MATCH, 0, (0, 0), 262, 364),
      475 => (RULE_MATCH, 0, (0, 0), 259, 366),
      476 => (RULE_SUCCESS, 0, (0, 0), 0, 443),
      477 => (RULE_MATCH, 0, (0, 0), 64, 327),
      478 => (RULE_SUCCESS, 0, (0, 0), 0, 444));
   ...
   Extensions : aliased constant Extension_Rules_Array := (
      ...
      (Ext_102'Access, 404, 407),
      (Ext_103'Access, 408, 414),
      (Ext_104'Access, 415, 416),
      (Ext_105'Access, 417, 418),
      (Ext_106'Access, 419, 420),
      (Ext_107'Access, 421, 425),
      (Ext_108'Access, 426, 426),
      (Ext_109'Access, 427, 428),
      (Ext_110'Access, 429, 430),
      (Ext_111'Access, 431, 431),
      (Ext_112'Access, 432, 433),
      (Ext_113'Access, 434, 441),
      (Ext_114'Access, 442, 442),
      (Ext_115'Access, 443, 443),
      (Ext_116'Access, 444, 445),
      (Ext_117'Access, 446, 447),
      (Ext_118'Access, 448, 449),
      (Ext_119'Access, 450, 451),
      (Ext_120'Access, 452, 454),
      (Ext_121'Access, 455, 456),
      (Ext_122'Access, 457, 457),
      (Ext_123'Access, 458, 460),
      (Ext_124'Access, 461, 462),
      (Ext_125'Access, 463, 464),
      (Ext_126'Access, 465, 468),
      (Ext_127'Access, 469, 472),
      (Ext_128'Access, 473, 476),
      (Ext_129'Access, 477, 478));
